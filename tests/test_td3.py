...
from modules.td3 import TD3Agent
...
<text x="{left}" y="18" font-size="16" font-family="monospace" fill="#111">TD3 reward curve</text>
...
<polyline fill="none" stroke="#17becf" stroke-width="2" points="{" ".join(points)}"/>
</svg>
""",
        encoding="utf-8",
    )
...
def test_td3_pendulum_smoke():
    ...
    svg_path = outputs_dir / "td3_rewards.svg"
    video_path = outputs_dir / "td3_pendulum_demo.mp4"
